...
import com.moneysplitter.party.model.SplitType;
import com.moneysplitter.service.PartyServiceImpl;
...
class PartyServiceImplTest {
    ...
    void shouldSaveParticipant() {
        Party savedParty = partyService.createParty(party);
        PartyParticipant savedParticipant = partyService.createParticipant(participant.withPartyId(savedParty.getId()));
    ...
    void shouldSaveEqualSpending() {
        ...
        PartyParticipant participantOne = partyService.createParticipant(participant.withPartyId(partyId));
        PartyParticipant participantTwo = partyService.createParticipant(participant.withPartyId(partyId));
        PartySpending spending = PartySpending
                ...
                .build();
        PartySpending savedSpending = partyService.createSpending(spending);
    ...
    void shouldCalculateTransactions() {
        ...
        PartyParticipant participantOne = partyService.createParticipant(participant.withPartyId(partyId));
        PartyParticipant participantTwo = partyService.createParticipant(participant.withPartyId(partyId));
        PartyParticipant participantThree = partyService.createParticipant(participant.withPartyId(partyId));
        PartyParticipant participantFour = partyService.createParticipant(participant.withPartyId(partyId));
        UUID participantOneId = participantOne.getId();
        UUID participantTwoId = participantTwo.getId();
        UUID participantThreeId = participantThree.getId();
        UUID participantFourId = participantFour.getId();

        partyService.createSpending(
    ...
    void shouldChangePartyAmount() {
        ...
        PartySpending savedSpending = partyService.createSpending(
                PartySpending.builder()
                        .partyId(partyId)
                        .payerId(participantOneId)
                        .name("Milk")
        ...
        partyService.deleteSpendingById(savedSpending.getPartyId(), savedSpending.getId());
