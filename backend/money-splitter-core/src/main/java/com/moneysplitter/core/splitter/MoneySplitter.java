...
public class MoneySplitter {
    ...
    public static OutputData split(InputData inputData) {
        ...
        return new OutputData(inputData.participants(), transactions);
    }

    private static List<Balance> calculateBalances(InputData inputData) {
        List<String> participants = inputData.participants();
        List<Spending> spendings = inputData.spendings();
