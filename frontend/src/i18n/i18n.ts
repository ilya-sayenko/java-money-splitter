  ...
  messages: {
    en: {
      ...
      errors: {
        ...
        participantDelete: 'Please remove spending with this participant!',
    ...
    ru: {
      ...
      errors: {
        ...
        participantDelete: 'Удалите расходы с данным участником, прежде чем удалить самого участника!',
